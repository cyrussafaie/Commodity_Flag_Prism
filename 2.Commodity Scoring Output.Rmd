...
div=sqldf('select div_nm, count(*) as "current" from fsa_final where cmdty_ind="Y" and div_nm not in ("CHARLOTTE","MILWAUKEE-WAUKESHA") group by div_nm ')
...
```{r}
cls=sqldf('select pim_cls_desc, count(*) from fsa_final where  div_nm not in ("CHARLOTTE","MILWAUKEE-WAUKESHA") group by pim_cls_desc ')
cls[order(cls$'count(*)'),]
...
```{r}
cls=sqldf('select pim_cls_desc, count(*) from fsa_final where cmdty_ind="Y" and div_nm not in ("CHARLOTTE","MILWAUKEE-WAUKESHA") group by pim_cls_desc ')
